...
export const metadata: Metadata = {
  ...
  title: { default: `${site.name} — See where every token goes`, template: `%s · ${site.name}` },
  ...
  openGraph: {
    type: "website",
    siteName: site.name,
    title: `${site.name} — See where every token goes`,
    description: site.description,
    images: [{ url: site.assets.ogImage, width: 1200, height: 630, alt: "TokenOptiPy TokenGraph" }],
  },
  twitter: { card: "summary_large_image", title: `${site.name} — See where every token goes`, description: site.description, images: [site.assets.ogImage] },
};
